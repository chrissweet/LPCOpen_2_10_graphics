 ...
 */
extern const LCD_CONFIG_T EA480x272;
extern const LCD_CONFIG_T QED640x480;

/**
 * Default LCD configuration data for examples
 */
//use QED640x480 or EA480x272
#define BOARD_LCD QED640x480
//#define BOARD_LCD EA480x272
